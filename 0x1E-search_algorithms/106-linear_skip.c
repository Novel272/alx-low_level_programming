...
/**
 * linear_skip - search for value in sorted list of integers
 * @list: lists of value
 * @value: value to locaet
 *
 * Return: If value not present in list or list is NULL, return -1.
 * Otherwise, retun first node where value is located.
 */
